...
def usage():
    ...
    print "-c --command                 - Initialize a command"
    print "-u --upload=destination      - Upon receiving conection upload a file and write to [dest]"
    print
    print "Examples:"
...
def main():
    ...
    # upload things, execute commands, nd drop a shell back
